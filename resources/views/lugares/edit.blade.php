    ...
    <body>
        <x-app-layout>
            ...
            <div class="container1">
                <form method="POST" action="{{ route('lugar.update', ['lugar' => $lugar->id]) }}" class="form1">
                    @method('put')
                    @csrf

                    <div class="mb-3">
                        <label for="id" class="form-label">Id</label>
                        <input type="text" class="input3" id="id" aria-describedby="idHelp" name="id" disabled="disabled" value="{{ $lugar->id }}">
                        <div id="idHelp" class="form-text">Id del sitio turístico</div>
                    </div>

                    <div class="mb-3">
                        <label for="name" class="form-label">Nombre:</label>
                        <input type="text" required class="input3" id="name" placeholder="Nombre del Sitio Turístico" name="name" value="{{ $lugar->name }}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" required class="input3" id="descripcion" placeholder="Descripción del Sitio Turístico" name="descripcion" value="{{ $lugar->descripcion }}">
                        @error('descripcion')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" required class="input3" id="direccion" placeholder="Dirección del Sitio Turístico" name="direccion" value="{{ $lugar->direccion }}">
                        @error('direccion')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" required class="input3" id="imagen" placeholder="URL de la Imagen del Sitio Turístico" name="imagen" value="{{ $lugar->imagen }}">
                        @error('imagen')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('lugar.index') }}" class="btn-delete submit1">Cancelar</a>
                    </div>
                </form>
            </div>
        ...
        <script>
            ...
            @if ($errors->any())
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Hubo un problema al actualizar el sitio turístico.',
