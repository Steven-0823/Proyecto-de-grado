...
<body>
    <x-app-layout>
        <x-slot name="header">
            <h2 class="title">
                {{ __('Agregando un nuevo restaurante') }}
            </h2>
        </x-slot>

        <div class="container">
            <div class="form-container">
                <form method="POST" action="{{ route('restaurante.store') }}" id="create-form">
                    @csrf
                    <div class="mb-3">
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
                        title: data.message || 'Restaurante creado correctamente',
                    ...
                    Swal.fire({
                        ...
                        icon: 'error',
                        title: 'Error',
                        text: data.error || 'Error al crear el restaurante',
