    ...
    <div class="fondobody">
        ...
        <div class="form">
            ...
            <div class="inputForm">
                ...
                <input class="input" id="email" type="email" name="email" placeholder="Enter your Email" value="{{ old('email') }}" required autofocus>
            </div>
            ...
            <p class="p">Don't have an account? <a class="span" href="{{ route('register') }}">Sign Up</a></p>
...
.inputForm:focus-within {
  border: 1.5px solid  rgb(255, 187, 0);
}
